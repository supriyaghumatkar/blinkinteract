...
if(isset($_POST['Action']) && $_POST['Action']=='SendMail' && !empty($_POST['questionQA']) && !empty($_POST['answerQA']))
{
   ...
   $datastringA=$_POST['answerQA'];
    ...
    {
           $messages.= "<tr><td>".$question[$i]."</td><td>".$answer[$i+1]."</td></tr>";
      $i++;     
    }
    $messages.="</ul>";
    //echo $messages;
...
$mail->addReplyTo('info@blink-interact.com','BlinkInteract');
$mail->addAddress('info@blink-interact.com');   // Add a recipient
$mail->addCC('tridib.ghosh@blink-interact.com');
$mail->addCC('supriya.ghumatkar@blink-interact.com');	
$mail->addCC('supriyakhopade9@gmail.com');	
