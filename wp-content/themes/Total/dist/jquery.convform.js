...
ConvState.prototype.answerWith = function(answerText, answerObject) {
   ...
   // console.log($("#messages").text());
    ...
    if (question=='Thanks for your time') {
        ...
        var questionQA=QQ;
        	$.ajax({				
					url:"http://demo33.blink-interact.com/blinkinteract/wp-content/themes/Total/email.php",
					type: "POST",
					data: {'answerQA':answerQA,'questionQA':questionQA,'Action':'SendMail'},
					datatype: "html",
					async: true,
					cache: false,
...
(function($){
    $.fn.convform = function(options){
        ...
        var parameters = $.extend(true, {}, {
            ...
            buttonClassStyle : '<img src="http://demo33.blink-interact.com/blinkinteract/wp-content/uploads/2019/04/send.png">',
            eventList : {
            ...
            loadSpinnerVisible : '',
            buttonText: '<img src="http://demo33.blink-interact.com/blinkinteract/wp-content/uploads/2019/04/send.png">'
        }, options);
